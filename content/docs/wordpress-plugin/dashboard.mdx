...
<Callout type="info">For new stores, the block-based dashboard is the way to go. Shortcodes are there for existing setups and classic editor sites that need a compatible option.</Callout>
