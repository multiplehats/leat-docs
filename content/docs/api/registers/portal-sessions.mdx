...
description: "A Portal Session is created for a Contact. Portal Sessions support different scanner_types, like camera or hand scanner, adding flexibility on how to interact w"
---
...
When creating a portal session, an optional `contact_uuid` can be provided. This will pre-fill the contact's details in the portal session. If no contact UUID is provided, the contact can be added in the portal session itself.
