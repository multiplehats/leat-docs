...
description: "If you already have a verification method in your own application – either through login, a saved uuid, magic link etc. - we recommend you use that one instead."
---
...
```text
https://api.piggy.eu/api//contact-verification/send
```
...
```text
https://api.piggy.eu/api//contact-verification/verify
```
...
```text
https://api.piggy.eu/api//contact-verification/auth-token/{{contact_uuid}}
```
