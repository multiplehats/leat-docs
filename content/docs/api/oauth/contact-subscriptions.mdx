...
description: "Contact Subscriptions are the links between Subscription Types and Contacts. A Contact is either subscribed or unsubscribed, which decides whether or not they w"
---
...
```text
https://api.piggy.eu/api//contact-subscriptions/{{contact_uuid}}
```
...
```text
https://api.piggy.eu/api//contact-subscriptions/{{contact_uuid}}/subscribe
```
...
```text
https://api.piggy.eu/api//contact-subscriptions/{{contact_uuid}}/unsubscribe
```
