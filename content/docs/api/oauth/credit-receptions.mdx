...
Credit Receptions have been largely replaced by top level entities such as [Orders](/v3/oauth/orders), [Visits](/v3/oauth/visits) and [Bookings](/v3/oauth/bookings). Please use those instead. If your use case doesn't fit any of these, please contact us at [dev@leat.com](mailto:dev@leat.com) to discuss.
