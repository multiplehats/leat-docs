...
This flow covers the core loyalty experience: identifying customers, displaying their rewards, and processing redemptions.
...
Once identified, the customer sees their loyalty information: tier status, point balance, available offers (vouchers and collectable rewards), and redeemable rewards.
